...
public class ExPodeEditarDataOrigem extends CompositeExpressionSupport {
	 ...
	 * @return
	 */
	public ExPodeEditarDataOrigem(ExModelo mod, DpPessoa titular, DpLotacao lotaTitular) {
		this.mod = mod;
	...
	protected Expression create() {
		return new ExPodePorConfiguracao(titular, lotaTitular).withExMod(mod).withExFormaDoc(mod.getExFormaDocumento())
				.withIdTpConf(ExTipoDeConfiguracao.EDITAR_ORIGEM);
	}
}